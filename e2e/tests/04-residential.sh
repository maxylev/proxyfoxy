...
proxyfoxy add res_user res_pass 8083 residential || { fail "add residential proxy"; return; }
pass "add residential proxy command"

sleep 3
wait_for_port 9000 40 || { fail "gateway listening on 9000"; return; }
pass "gateway listening on 9000"
wait_for_port 8083 10 || { fail "consumer port 8083"; return; }
