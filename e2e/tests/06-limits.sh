...
proxyfoxy add lim_user lim_pass 8091 residential --limit=5KB > /dev/null 2>&1 || { fail "add limited proxy"; return; }
...
wait_for_port 9000 30 || { fail "gateway on 9000 for limit test"; proxyfoxy delete lim_user 8091 > /dev/null 2>&1; return; }
pass "gateway listening on 9000"

wait_for_port 8091 15 || { fail "consumer on 8091 for limit test"; proxyfoxy delete lim_user 8091 > /dev/null 2>&1; return; }
